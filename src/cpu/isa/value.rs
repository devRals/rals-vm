...
use crate::cpu::{Decode, DecodeError, Encode, isa::instructions::Operand};
...
pub(crate) fn shl_carry<T: ImmediateValue>(value: T, amount: u32) -> bool {
    if amount == 0 {
        return false;
    }
...
pub(crate) fn shr_carry<T: ImmediateValue>(value: T, amount: u32) -> bool {
    if amount == 0 {
        return false;
    }
